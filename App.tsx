  ...
  return (
    <View style={[styles.tabBar, {paddingBottom: bottom}]}>
      <AnimatedSvg
        ...
        <Path
          fill="#F0F8F6"
          d="M101 44s-11.277.037-16.579-20.656C82.68 16.55 80.961 11.611 79.07 8.19 76.181 2.958 71.485 0 66.581 0H34.419c-4.912 0-9.6 2.958-12.488 8.189-1.892 3.422-3.61 8.36-5.352 15.155C11.277 44.037 0 44 0 44"
        />
        <Path
          fill="#40C1AC"
          d="M52.466 43H95.95l2.525 1.125L101 44.5H0l2.02-.375L5 43h47.466Z"
        />
      </AnimatedSvg>
